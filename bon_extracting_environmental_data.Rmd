...
# Background
Linking species occurrences and evolution to environmental variables and quantifying species "niche" and its evolution is essential for many biogeographic questions. 
...
occ <- read_csv("example_data/bonus/cleaned_occurrences_bombacoideae.csv")
env <- raster("example_data/bonus/wc2.0_bio_5m_01.tif")
```
