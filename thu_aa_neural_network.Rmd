...
Hence, different types of input can be used including gepgraphicfeatures, climate data, presence/absence in different biomes, or other traits. 
Here we will use geographi features only, based on GBIF occurrences. 

### Geographic occurrence records of training species (training occurrences)
