...
# set the maximum number of areas. If you have many areas, you can set the maximum number of areas a species can occur in simultaneously. One possibility is to set this to the number of areas of the most widespread recent species.
max_range_size = 5 
...
BioGeoBEARS_run_object$min_branchlength = 0.000001 # fix issues with zero-branch lengths   
BioGeoBEARS_run_object$include_null_range = TRUE  
BioGeoBEARS_run_object$speedup = TRUE         
BioGeoBEARS_run_object$use_optimx = 'GenSA'     # if FALSE, use optim() instead of optimx()
BioGeoBEARS_run_object$num_cores_to_use = 4 # if parallel computing is not available this will default to 1
